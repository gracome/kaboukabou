...
void main() {
  runApp(MaterialApp(
    home: Classement1Page(),
  ));
}

class Classement1Page extends StatefulWidget {
  @override
  _Classement1PageState createState() => _Classement1PageState();
}

class _Classement1PageState extends State<Classement1Page> {
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      ...
      case 1:
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => Classement1Page()),
        );
        break;
      case 2:
        Navigator.pushReplacement(
